...
<body>
    ...
    <a href="ogrenci_ekle.php" class="menu-item"> → Öğrenci Ekleme</a>
    <a href="ogrenci_sil.php" class="menu-item"> → Öğrenci Silme</a>
   
    <a href="ders_ekle_danisman.php" class="menu-item"> → Ders Ekleme</a>
    <a href="akademik_takvim_danisman.php" class="menu-item"> → Akademik Takvim</a>

   
    <a href="basvurular.php" class="menu-item"> → Öğrenci Başvuruları</a>
    <a href="gelen_mesajlar_danisman.php" class="menu-item"> → Gelen Mesajlar</a>
    <a href="duyuru_ekle_danisman.php" class="menu-item"> → Duyuru Oluşturma</a>
...
<div class="content">
    <div class="topbar">
        ...
        <div class="user-info">
            ...
            <div>Bilgi İşlem Görevlisi - <?= htmlspecialchars($_SESSION['ad_soyad']) ?></div>
        </div>
    </div>
    ...
    <div class="dashboard">
        <div class="card">
            <h3>Hoş geldiniz</h3>
            <p>Sayın <?= htmlspecialchars($_SESSION['ad_soyad']) ?>, Yönetici Paneline Hoş Geldiniz!</p>
        </div>
       ...
       <a href="ogrenci_listesi_danisman.php" style="text-decoration: none; color: inherit;">
